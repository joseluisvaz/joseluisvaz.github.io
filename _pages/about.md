...
<tr>
<td class="col-sm-2" width="40%"><a href='https://arxiv.org/abs/2003.04882' target='_blank'><img src="/images/control_diagram.jpg"/></a> </td>
<td>
...
[<a href='javascript:;'
    onclick='$("#abs_3dv_project").toggle()'>description</a>] [[report]({{ site.url }}/files/3dv_report.pdf)] <br>
...
[<a href='javascript:;'
    onclick='$("#abs_plr_project").toggle()'>description</a>] [[report]({{ site.url }}/files/plr_report.pdf)] <br>
...
[<a href='javascript:;'
    onclick='$("#abs_dl_project").toggle()'>description</a>] [[report]({{ site.url }}/files/deep_learning_report.pdf)] <br>
...
[<a href='javascript:;'
    onclick='$("#abs_vision").toggle()'>description</a>] [[report]({{ site.url }}/files/vision_report.pdf)] [<a href='https://www.youtube.com/watch?v=dyNT3g425sU&feature=youtu.be' target='_blank'>video</a>]<br>
